 ...
 * I have implemented comparable to sort the recipes by the last modified field
 */
...
public class Recipe implements Comparable<Recipe> {
    ...
    public int compareTo(Recipe o) {
        if(lastModified==null&&o.getLastModified()==null){
        return o.getLastModified().compareTo(lastModified);}
        return o.getDateCreated().compareTo(dateCreated);
    }
}
